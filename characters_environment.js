...
function start_game(){
  game_status = "start";
  document.getElementById("status").innerHTML = game_status;
}

function game(){

  console.log(noseX,noseY,game_status);
  instializeInDraw();
  ...
  if(gameConfig.status==='start'){
    ...
    textSize(40);
    textAlign(CENTER);
    text("Press the start button ", gameConfig.screenX/2, gameConfig.screenY/2);
    textSize(40);
